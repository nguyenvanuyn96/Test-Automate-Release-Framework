...
Pod::Spec.new do |s|
  ...
  s.version      = "0.1.10"
  s.summary          = 'A short description of Test-Automate-Release-Framework. Edit for testing'
...
TODO: Add long description of the pod here.
  ...
  s.homepage         = 'https://github.com/Uy Nguyen/Test-Automate-Release-Framework'
  # s.screenshots     = 'www.example.com/screenshots_1', 'www.example.com/screenshots_2'
  s.license          = { :type => 'MIT', :file => 'LICENSE' }
  s.author           = { 'Uy Nguyen' => 'nguyenvanuyn96@gmail.com' }
  s.source           = { :git => 'https://github.com/Uy Nguyen/Test-Automate-Release-Framework.git', :tag => s.version.to_s }
