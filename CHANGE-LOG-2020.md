...
- Fix bug can not run auto create release tag workflow
- Fix bug can not run auto create release tag workflow by step 26
...
- Fix bug can not get changelog for release tag

## [Released] 1.0.52
- Trying the workflow_run_2
